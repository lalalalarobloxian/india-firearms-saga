...
export const TIERS: Tier[] = [
  ...
  { tier: 10, reward: { kind: "unlock", label: "Lee-Enfield SMLE", itemType: "weapon", itemId: "smle" } },
  ...
  { tier: 14, reward: { kind: "unlock", label: "Subhas Chandra Bose", itemType: "character", itemId: "subhas" } },
